...
3. The impact of not taxing social security:
    - Fiscal.
    - Distributional.
4. How does "taxing payroll taxes instead" work as a pay-for proposal
...
- Another way to see elderly population growth is to look at projected growth (not shares) of the federal budget items over the next 30 years (CBO 2025). \pause
...
- Understand that:
    1. The fiscal implication is that a tax on social security benefits is that it reduces the net amount of retirement spending.
        - Alleviates the Fundamental Problem of Retirement Spending. \pause
...
The policy costs roughly $1.3 trillion over ten years.
...
- Note that taxing payroll contributions is identical to a flat tax, so this distributional pattern will be common to most revenue proposals.
