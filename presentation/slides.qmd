...
3. The impact of not taxing social security:
    - Fiscal.
    - Distributional.
4. "Taxing payroll taxes" as a pay-for.
...
- Intuition fits reality:
    ...
    - In fact, the government has taken money out of the trust funds to finance general expenditures before, so the payroll contributions aren't really stored in a separate pot of money. \pause
...
- But is a social security benefits any less odd? \pause 
- Intuitively and economically, government payments are part of the tax-and-transfer system, and therefore *post-tax*.
  - But the law treats this class of payment as pre-tax. \pause
...
- Removing the tax and taxing workers more is fiscally better but worse for age-distributional reasons.
